<script>
  ...
  <!-- License Box -->
  <div
	class="relative mx-auto my-10 w-[527px] rounded-[23.48px] border-[3px] border-[#ABBED1] bg-[#EEEEEE] px-[38px] pt-[100px] pb-[68px]"
  ...
  >
	...
	<button
	  ...
	  aria-label="Close"
	>
	  <X class="w-[23.48px] h-[23.48px]" />
	</button>
  
	<!-- Inner layout -->
	<div class="flex flex-col gap-[85px] w-[449px]">
